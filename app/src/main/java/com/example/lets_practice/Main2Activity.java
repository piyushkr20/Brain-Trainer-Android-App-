...
public class Main2Activity extends AppCompatActivity {
    ...
    public void restart(View view) {
        ...
        new CountDownTimer(5100, 1000) {
            public void onTick(long millisUntilFinished) {
                TextView textView = Main2Activity.this.text;
                textView.setText(String.valueOf((int) (millisUntilFinished / 1000)) + "s");
            }

            public void onFinish() {
                Main2Activity.this.restart = false;
                Main2Activity.this.text2.setVisibility(View.VISIBLE);
                TextView textView = Main2Activity.this.text4;
                textView.setText("SUBTRACTION OVER! yr score is " + String.valueOf(Main2Activity.this.f33c) + "/" + String.valueOf(Main2Activity.this.f34d));
                Main2Activity.this.button5.setEnabled(true);
                Main2Activity.this.button6.setEnabled(true);
            }
        }.start();
    }
    ...
    public void press(View view) {
        if (this.restart) {
            ...
            this.text3.setText(String.valueOf(this.f33c) + "/" + String.valueOf(this.f34d));
            getQuestion();
            return;
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.text4.setVisibility(View.VISIBLE);
        this.button6.setText("MULTIPLICATION");
    }
}
